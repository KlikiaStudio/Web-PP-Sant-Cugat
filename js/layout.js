...
(function () {
  ...
  function headerHTML(active) {
    ...
    return ''
      ...
      + '      <img id="logoImg" src="img/equipo/Logo PP web.png" alt="Logo Partido Popular" style="height:160px;width:auto;">'
      + '    </a>'
