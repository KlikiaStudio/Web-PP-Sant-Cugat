...
(function () {
  ...
  function socialIcon(net, size) {
    return '<svg width="' + size + '" height="' + size + '" viewBox="0 0 24 24" fill="currentColor">' + SOCIAL_ICON_PATH[net] + '</svg>';
  }
  var SOCIAL_ICON_SVG = {
    facebook: socialIcon('facebook', 18),
    x: socialIcon('x', 18),
    instagram: socialIcon('instagram', 18),
    youtube: socialIcon('youtube', 18),
    tiktok: socialIcon('tiktok', 18),
    whatsapp: socialIcon('whatsapp', 18)
  };
  var SOCIAL_ICON_SVG_TOPBAR = {
    facebook: socialIcon('facebook', 14),
    x: socialIcon('x', 14),
    instagram: socialIcon('instagram', 14),
    youtube: socialIcon('youtube', 14),
    tiktok: socialIcon('tiktok', 14),
    whatsapp: socialIcon('whatsapp', 14)
  };
  var NAV_ITEMS = [
  ...
  function headerHTML(active) {
    ...
    return ''
      ...
      + '      <a href="mailto:info@ppsantcugat.es"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"/></svg> [info@ppsantcugat.es]</a>'
      + '    </div>'
      + '    <div class="topbar-right">'
      + '      <div class="social-inline" id="topSocial">'
      + '        <a href="#" aria-label="Facebook" data-net="facebook">' + SOCIAL_ICON_SVG_TOPBAR.facebook + '</a>'
      + '        <a href="#" aria-label="X" data-net="x">' + SOCIAL_ICON_SVG_TOPBAR.x + '</a>'
      + '        <a href="#" aria-label="Instagram" data-net="instagram">' + SOCIAL_ICON_SVG_TOPBAR.instagram + '</a>'
      + '        <a href="#" aria-label="YouTube" data-net="youtube">' + SOCIAL_ICON_SVG_TOPBAR.youtube + '</a>'
      + '        <a href="#" aria-label="TikTok" data-net="tiktok">' + SOCIAL_ICON_SVG_TOPBAR.tiktok + '</a>'
      + '        <a href="#" aria-label="WhatsApp" data-net="whatsapp">' + SOCIAL_ICON_SVG_TOPBAR.whatsapp + '</a>'
      + '      </div>'
  ...
  function footerHTML() {
    return ''
      ...
      + '        <a class="scircle" style="background:rgba(255,255,255,.1);color:#fff;" href="#" aria-label="Facebook" data-net="facebook">' + SOCIAL_ICON_SVG.facebook + '</a>'
      + '        <a class="scircle" style="background:rgba(255,255,255,.1);color:#fff;" href="#" aria-label="Instagram" data-net="instagram">' + SOCIAL_ICON_SVG.instagram + '</a>'
      + '        <a class="scircle" style="background:rgba(255,255,255,.1);color:#fff;" href="#" aria-label="YouTube" data-net="youtube">' + SOCIAL_ICON_SVG.youtube + '</a>'
      + '        <a class="scircle" style="background:rgba(255,255,255,.1);color:#fff;" href="#" aria-label="X" data-net="x">' + SOCIAL_ICON_SVG.x + '</a>'
      + '        <a class="scircle" style="background:rgba(255,255,255,.1);color:#fff;" href="#" aria-label="TikTok" data-net="tiktok">' + SOCIAL_ICON_SVG.tiktok + '</a>'
      + '      </div>'
      + '    </div>'
      + '    <div>'
